...
db_path = os.path.abspath(os.path.join(BASE_DIR, "..", "bima_scrapper", "nutrikost.db"))
...
class RiwayatPage(QWidget):
    ...
    def _build_content(self):
        ...
        self.action_btn.setFixedSize(145, 50)
        ...
        # Area Scroll untuk konten utama
        scroll = QScrollArea()
        ...
        filter_container.setMaximumWidth(450)
        filter_container.setStyleSheet('QFrame { background: #1A7A34; border-radius: 24px; }')
